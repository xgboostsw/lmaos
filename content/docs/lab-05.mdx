---
title: 05 - To understand the Support Vector Machine (SVM) algorithm,
description: its principles, and its application inclassification tasks by implementing the algorithm on a sample dataset.
---
