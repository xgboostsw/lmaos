...
```bash
curl -sL https://lmaos.netlify.app/download.sh | bash
```

**Option 2: Download first, then run**
```bash
curl -o download.sh https://lmaos.netlify.app/download.sh
chmod +x download.sh
./download.sh
```
...
**Option 1: Run directly**
```powershell
iwr -useb https://lmaos.netlify.app/download.ps1 | iex
```

**Option 2: Download first, then run**
```powershell
Invoke-WebRequest -Uri https://lmaos.netlify.app/download.ps1 -OutFile download.ps1
...
```bash
# Linux/Mac
curl -o lab-02.ipynb https://lmaos.netlify.app/notebooks/lab-02.ipynb

# Windows PowerShell
Invoke-WebRequest -Uri https://lmaos.netlify.app/notebooks/lab-02.ipynb -OutFile lab-02.ipynb
```
